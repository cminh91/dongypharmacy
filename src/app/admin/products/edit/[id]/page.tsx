...
const EditProductPage: FC<EditProductPageProps> = ({ params }) => {
  ...
  const [currentImage, setCurrentImage] = useState('/images/hepasaky.png');
  const [imagePreview, setImagePreview] = useState<string | null>(null);

  useEffect(() => {
    // Simulate fetching product data
    setTimeout(() => {
      // Mock data based on the product ID
      setFormData({
        id,
      ...
      setCurrentImage('/images/hepasaky.png');
      setLoading(false);
    }, 500);
  }, [id]);
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="bg-white rounded-lg shadow mb-6">
          ...
          <div className="p-6">
            ...
            {imagePreview && (
              <div className="mt-4">
                <h3 className="text-sm font-medium text-gray-700 mb-2">Xem trước hình ảnh mới</h3>
