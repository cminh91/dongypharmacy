      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0 md:pr-12">
            <h2 className="text-3xl font-bold mb-6">Về Đông Y Pharmacy</h2>
            <p className="text-gray-600 mb-4">Đông Y Pharmacy được thành lập vào năm 2010, là đơn vị chuyên nghiên cứu, sản xuất và phân phối các sản phẩm thuốc đông y chất lượng cao.</p>
